...
<body>
        ...
        <div id="buttonContainer"><br><br>
			<a class="press" href="/addVehicle">Add Vehicle </a>
            <a class="press" href="/deleteVehicle">Delete Vehicle</a>
            <a class="press" href="/updateVehicle">Update Vehicle</a>
             <a href="/logout" id="logout" class="press">Logout</a>
